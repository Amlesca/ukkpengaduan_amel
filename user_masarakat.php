...
$cari = $_POST ['cr'];
if ($cari !=''){
$query = mysqli_query ($conn, "SELECT * FROM masyarakat WHERE nama LIKE '%".$cari."%'
	OR nik LIKE '%".$cari."%' OR alamat LIKE '%".$cari."%'");}else{
	$query = mysqli_query ($conn, "SELECT * FROM masyarakat LIMIT $posisi,$batas");
}
...
<?php
	$query2		= mysqli_query($conn, "SELECT * FROM masyarakat");
