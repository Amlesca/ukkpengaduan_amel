                            ...
                            <div class="col-xl-3 col-lg-2">
                                <div class="logo">
                                    <a href="masarakat_admin.php">
                                        <img src="Login/img/icon.png" alt="">
                                    </a>
                                </div>
                            </div>
        ...
        <div class="slider_active owl-carousel">
            <div class="single_slider  d-flex align-items-center slider_bg_2 overlay2">
             ...
             <div class="slider_text ">
                                ...
                                <p style="color:white">Selamat datang di web Pengaduan Masyarakat Kabupaten Jombang<br>
                                    Silahkan adukan Keluh Kesah anda terhadap pemerintahan Kabupaten Jombang</p>
...
<form>
 ...
 &copy;<script>document.write(new Date().getFullYear());</script> tugasukk | <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" target="_blank">Novita Amelia Safitri</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
                </div>
