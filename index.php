                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-6 col-md-6 ">
                         <li><a href="https://maps.app.goo.gl/sKu4MRQ31c1oAHj88" style="color:white"><i class="fa fa-podcast"> Kantor Pemerintah Kabupaten Jombang</i></a></li>
                        </div>
                        <div class="col-xl-6 col-md-6">
                            <div class="short_contact_list">
                                <ul>
                                    <li><a href="#"> <i class="fa fa-envelope"></i> PemkabJombang@gmail.com</a></li>
                                    <li><a href="#"> <i class="fa fa-phone"></i>0321861748</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="header_bottom_border">
                        <div class="row align-items-center">
                            <div class="col-xl-3 col-lg-2">
                                <div class="logo">
                                    <a href="index.php">
                                        <img src="img/Logo_Jombang.png" alt="">
                                    </a>
                                </div>
                            </div>
...
?>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="slider_text">
                                <h3> Situs Web Pelaporan<br>
                                    Pengaduan Masyarakat</h3>
                                <p>Selamat datang di web Pengaduan Masyarakat Kabupaten Jombang<br>
 ...
 &copy;<script>document.write(new Date().getFullYear());</script> tugas ukk | <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" target="_blank">Novita Amelia Safitri</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
                </div>
